/**
 * =============================================================
 * VOXWALL Security System — Vibration Sensor Node
 * Hardware: ESP32-C3 Super Mini
 * 
 * Configuration:
 *   - Pin: 4 (INPUT_PULLUP, for 801S vibration switch)
 *   - Trigger: LOW (vibration detected)
 *   - Cooldown: 5 seconds (prevents rapid re-triggers)
 *   - Type: VIBRATION
 *   - Events: VIBRATION_DETECTED
 * 
 * BEFORE FLASHING:
...
#define SENSOR_PIN        4
#define SENSOR_INPUT_MODE INPUT_PULLUP  // Normally-open switch
...
void loop() {
    ...
    // TRIGGER_LEVEL = LOW (vibration switch triggered on INPUT_PULLUP)
